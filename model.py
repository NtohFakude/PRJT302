...
firebase_admin.initialize_app(cred, {'databaseURL': 'https://heartchat-7268c-default-rtdb.firebaseio.com/'})
...
def make_prediction(responses):
    try:
        ...
        features = np.array(features).reshape(1, -1)  # Reshape to (1, num_features)
